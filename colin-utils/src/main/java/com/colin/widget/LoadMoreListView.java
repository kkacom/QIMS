...
import com.colin.capture.colin_utils.R;
...
public class LoadMoreListView extends ListView implements OnScrollListener {
	...
	public void initHeaderView() {
		headView = inflater.inflate(R.layout.layout_listview_header, null);
...
//		logd("External call onRefreshComplete !!");
	...
	public interface OnPullListener {
		void onPullDownRefresh(View headView);

		void onPullUpLoadMore(LoadMode mode, ProgressBar footBar, TextView loadTextView);
	}
