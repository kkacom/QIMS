...
public class SgAndPtFragmentFive extends Fragment {
    /**这是保存签名图片的地址*/
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        USER_SIGN_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "signFive" + ".png";
        initView();
        return view;
    ...
    private void initView() {
        ...
        Album.initialize(AlbumConfig.newBuilder(getContext())
            ...
            .build());
        //读取保存的位图（图片）
        mBitmap = SPUtil.getBitmap(getContext(),"PHOTOTFIVE",null);
        if(mBitmap!=null){
            mIvUserPhoto.setImageBitmap(mBitmap);
        }
        mIvSign.setImageBitmap(SPUtil.getBitmap(getActivity(),"SIGNFIVE",null));
        mTvTakePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Album.startAlbum(SgAndPtFragmentFive.this,ALBUM_RESULT,1);
        ...
        mTvSavePhoto.setOnClickListener(new View.OnClickListener() {
           @Override
            public void onClick(View v) {
               SPUtil.putBitmap(getActivity(),"PHOTOFIVE",mBitmap);
        ...
        mTvSaveSign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SPUtil.putBitmap(getActivity(),"SIGNFIVE",bm);
