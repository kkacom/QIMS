...
/**
 * app更新下载后台服务（老版本，不适配Android6.0、7.0版本）
 * 保留
 */
public class UpdateService extends Service {
    ...
    public void onCreate() {
        ...
        filePath = Environment.getExternalStorageDirectory() + "/mes-aps/mes-aps.apk";
    }
    ...
    private void notifyUser(String result, String reason, int progress) {
        ...
        build.setSmallIcon(R.drawable.rf)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.rf))
